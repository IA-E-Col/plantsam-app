...
def segment_with_multiple_points(image_bytes: bytes, positive_points: List[Tuple[int, int]], negative_points: List[Tuple[int, int]]):
...
async def segment_with_points(
    ...
    buf = segment_with_multiple_points(image_bytes, pos_points, neg_points)
    return StreamingResponse(buf, media_type="image/png")
